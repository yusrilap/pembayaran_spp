...
<head>
    ...
    <title>E-Pembayaran UDB UDT Sekolah Sekolah</title>
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ url('assets/images/users/user.png') }}" alt="user" class="rounded-circle" width="31"></a>
                        </li>
                    </ul>
                </div>
            </nav>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                <div class="user-pic"><img src="{{ url('assets/images/users/user.png') }}" alt="users" class="rounded-circle" width="40" /></div>
